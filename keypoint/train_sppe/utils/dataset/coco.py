...
class Mscoco(data.Dataset):
    def __init__(self, train=True, sigma=1,
        ...
        if train:
            self.img_folder = '/home/penggao/projects/pose/kppose/data/02/train' # test cluster
        else: # validation dataset
            self.img_folder = '/home/penggao/projects/pose/kppose/data/02/eval' # test cluster
        ...
        if train:
            filepath = os.path.join('/home/penggao/projects/pose/kppose/data/02/', "annot_train.h5") # test cluster
            ...
            filepath = os.path.join('/home/penggao/projects/pose/kppose/data/02/', "annot_eval.h5")
            with h5py.File(filepath, 'r') as annot:
                # val
