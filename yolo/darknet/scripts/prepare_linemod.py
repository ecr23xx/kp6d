...
DARKNET = '/home/penggao/projects/kp6d/yolo/darknet/data'  # Darknet data root
...
if __name__ == '__main__':
    ...
    with open(opj(DARKNET, 'all.txt'), 'w') as f:
